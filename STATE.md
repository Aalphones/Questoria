...
**Aktiver Plan:** [docs/planning/2026-08-19_ui-umbau-vollbild/README.md](docs/planning/2026-08-19_ui-umbau-vollbild/README.md) — **Phase 4 von 5 (Lernstufen mit Bild)**, Rating heikel — Schema-Änderung + ADR, `opusplan`/`opus` statt `sonnet`.

**Nächster Schritt:** Phase 4 planen/umsetzen — [phase-4-lernstufen.md](docs/planning/2026-08-19_ui-umbau-vollbild/phase-4-lernstufen.md) lesen. Generisches Bild-pro-Lernstufe-Konzept über alle Welten, nicht Pokémon-hartkodiert; braucht Content-Schema-Änderung und einen ADR, bevor Code entsteht.
