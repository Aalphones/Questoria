...
| 6 | [Karten-Knopf, Kartenausbau, Doku](phase-6-knopf-testwelt-doku.md) | Karten-Knopf in der Kopfleiste, `pokemon` auf ≥11 Karten ausbauen, alle Doku-Nachträge | mechanisch | pending |
