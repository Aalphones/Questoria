...
| Timeline | `features/timeline/` | Etappenkarte pro Welt, Fortschrittsmarkierung mit Sternen. Vier Sichtbarkeits-Zustände pro Etappe (erkundet/aktuell/entdeckt/unbekannt, ADR-024) — unabhängig von `ProgressState` |
| Map | `features/map/` | Interaktive Ortskarte pro Arc — Orte als Punkte, Routen, Kompassrose. Dieselben vier Sichtbarkeits-Zustände wie die Timeline (ADR-024) |
