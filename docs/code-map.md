...
| Kartenfläche | `ui/map-canvas/` | Gemeinsames Bauteil von Planeten-, Etappen- und Ortskarte: kachelbasierte, fortschrittsgesteuerte Kartenfläche mit offenem Koordinatensystem (1024×1024-Kacheln, nur freigeschaltete werden geladen), Routenlinien, Ziehen und Zoomen ohne Fremdbibliothek und exakt auf die freigeschaltete Fläche geklemmt ([ADR-019](decisions/019-panzoom-ohne-bibliothek.md)); `map-point/` setzt ein beliebiges Kind auf eine Weltposition (Pixel) |
