...
| Kartenfläche | `ui/map-canvas/` | Gemeinsames Bauteil von Planeten-, Etappen- und Ortskarte: kachelbasierte, fortschrittsgesteuerte Kartenfläche mit offenem Koordinatensystem (1024×1024-Kacheln, nur freigeschaltete werden geladen), Routenlinien; `map-point/` setzt ein beliebiges Kind auf eine Weltposition (Pixel) |
